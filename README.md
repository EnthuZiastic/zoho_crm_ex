...
# Note: If search returns 204 (no content), the placeholder will fail with INVALID_REFERENCE
input = InputRequest.new("access_token")
|> InputRequest.with_body(%{
  "parallel_execution" => false,
  "__composite_requests" => [
    %{"method" => "GET", "reference_id" => "search_contact",
      "url" => "/crm/v8/Contacts/search",
      "params" => %{"criteria" => "(Email:equals:test@example.com)"}},
    %{"method" => "PUT", "reference_id" => "update_contact",
